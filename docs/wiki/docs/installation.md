...
=== "BungeeCord"
    ...
    ```groovy
    dependencies {
        implementation("com.github.shynixn.mccoroutine:mccoroutine-bungeecord-api:2.21.0")
        implementation("com.github.shynixn.mccoroutine:mccoroutine-bungeecord-core:2.21.0")
    }
    ```
...
=== "Fabric"
    ...
    ```groovy
    dependencies {
        implementation("com.github.shynixn.mccoroutine:mccoroutine-fabric-api:2.21.0")
        implementation("com.github.shynixn.mccoroutine:mccoroutine-fabric-core:2.21.0")
    }
    ```
...
=== "Sponge"
    ...
    ```groovy
    dependencies {
        implementation("com.github.shynixn.mccoroutine:mccoroutine-sponge-api:2.21.0")
        implementation("com.github.shynixn.mccoroutine:mccoroutine-sponge-core:2.21.0")
    }
    ```
...
=== "Folia"
    ...
    **plugin.yml**
    ```yaml
    libraries:
      - com.github.shynixn.mccoroutine:mccoroutine-folia-api:2.21.0
      - com.github.shynixn.mccoroutine:mccoroutine-folia-core:2.21.0
    ```
