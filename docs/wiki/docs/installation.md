...
=== "Sponge"
    ...
    ```groovy
    dependencies {
        implementation("com.github.shynixn.mccoroutine:mccoroutine-sponge-api:2.2.0")
...
=== "Velocity"
    ...
    ```groovy
    dependencies {
        implementation("com.github.shynixn.mccoroutine:mccoroutine-velocity-api:2.2.0")
        implementation("com.github.shynixn.mccoroutine:mccoroutine-velocity-core:2.2.0")
    }
    ```
...
=== "Bukkit Server 1.17 - Latest"
    ...
    **plugin.yml**
    ```yaml
    libraries:
      - com.github.shynixn.mccoroutine:mccoroutine-bukkit-api:2.2.0
