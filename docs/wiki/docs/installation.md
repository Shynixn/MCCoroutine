...
=== "Bukkit"
    ...
    ```groovy
    dependencies {
        implementation("com.github.shynixn.mccoroutine:mccoroutine-bukkit-api:2.0.0")
        implementation("com.github.shynixn.mccoroutine:mccoroutine-bukkit-core:2.0.0")
    }
    ```
...
=== "BungeeCord"
    ...
    ```groovy
    dependencies {
        implementation("com.github.shynixn.mccoroutine:mccoroutine-bungeecord-api:2.0.0")
        implementation("com.github.shynixn.mccoroutine:mccoroutine-bungeecord-core:2.0.0")
    }
    ```
...
=== "Sponge"
    ...
    dependencies {
        ...
        implementation("com.github.shynixn.mccoroutine:mccoroutine-sponge-core:2.0.0")
    }
    ```
...
=== "Bukkit Server 1.17 - Latest"
    ...
    **plugin.yml**
    ```yaml
    libraries:
      - com.github.shynixn.mccoroutine:mccoroutine-bukkit-api:2.0.0
      - com.github.shynixn.mccoroutine:mccoroutine-bukkit-core:2.0.0
    ```
