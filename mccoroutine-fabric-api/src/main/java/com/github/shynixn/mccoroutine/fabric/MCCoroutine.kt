...
/**
 * Gets the server coroutine scope.
 */
 ...
 * If the current thread is not the minecraft server thread, the coroutine is moved to the main scheduler and executed
...
interface MCCoroutine {
     ...
     */
    fun getCoroutineSession(extension: DedicatedServerModInitializer): CoroutineSession
