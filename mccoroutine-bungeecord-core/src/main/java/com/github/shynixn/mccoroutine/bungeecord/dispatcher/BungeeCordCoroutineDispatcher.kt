package com.github.shynixn.mccoroutine.bungeecord.dispatcher
...
internal class BungeeCordCoroutineDispatcher(private val plugin: Plugin) : CoroutineDispatcher() {
    /**
